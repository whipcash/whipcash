...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Whipcash " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"whipcashtools.com", "dnsseed.whipcashtools.com"},
    {"whipcashpool.org", "dnsseed.whipcashpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"whipcashtools.com", "testnet-seed.whipcashtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Whipcash is probably already running."), addrBind.ToString().c_str());
        else
